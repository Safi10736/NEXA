...
export default function AdminSettings() {
  ...
  const [preferences, setPreferences] = useState({
    emailOrderAlerts: settings.orderEmailEnabled !== false,
  ...
  const handleFileUpload = async (
    ...
    key: "heroBannerUrl" | "loginSidebarUrl",
  ) => {
  ...
  const handleSave = async () => {
    ...
    // Always persist all site configuration changes
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
        <div>
          <h1 className="text-4xl font-light tracking-tighter mb-2">
            Terminal{" "}
            <span className="serif italic text-brand-accent">Settings</span>
          </h1>
          <p className="text-xs text-neutral-500 lowercase tracking-wide">
            Configure Nexa administrative protocols and visual identity nodes.
          </p>
        </div>
        <button
          onClick={handleSave}
        ...
        <div className="lg:col-span-4 space-y-4">
          {[
            ...
            >
              ...
              {activeCategory === item.id && (
                <ArrowRight className="w-4 h-4 ml-auto text-brand-accent/50" />
              )}
            </button>
          ))}
        </div>
        ...
        <div className="lg:col-span-8 space-y-6">
          {success && (
            ...
            >
              ...
              <div>
                <h5 className="text-[10px] font-bold uppercase tracking-widest text-green-500">
                  Protocol Updated
                </h5>
                <p className="text-[8px] text-green-500/60 uppercase tracking-tighter">
                  Your administrative preferences have been synced successfully.
                </p>
              </div>
            </motion.div>
          )}
            ...
            {activeCategory === "notifications" && (
              <section className="space-y-8">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-[11px] font-bold uppercase tracking-[0.3em] text-neutral-300">
                    Notification Preferences
                  </h2>
                </div>

                <div className="p-6 bg-neutral-900/20 border border-neutral-900 rounded-3xl space-y-4 mb-8">
                  <h3 className="text-[9px] font-bold uppercase tracking-[0.2em] text-[#d4af37] flex items-center gap-2">
                    <span>⚜️</span> Google Apps Script Setup Blueprint
                  </h3>
                  <p className="text-[8px] text-neutral-400 uppercase tracking-tighter leading-loose">
                    Automatically send gorgeous email confirmations to yourself
                    and your buyers on every checkout! The complete Google Apps
                    Script code and elegant gold-and-charcoal HTML email
                    templates are crafted for you inside the{" "}
                  ...
                  <div className="flex gap-4">
                    <a
                      ...
                      className="inline-block text-[8.5px] font-bold uppercase tracking-widest text-[#d4af37] bg-neutral-950 border border-neutral-800 px-5 py-3 rounded-lg hover:border-brand-gold hover:bg-[#d4af37]/5 transition-all"
                    >
                ...
                <div className="space-y-6">
                  <div className="flex items-center justify-between p-6 bg-neutral-900/50 rounded-2xl border border-neutral-900 group hover:border-brand-accent/30 transition-all">
                    <div className="flex items-center gap-6">
                      ...
                      <div>
                        ...
                        <p className="text-[8px] text-neutral-500 uppercase tracking-tighter leading-relaxed">
                          Receive instantaneous notifications when a new
                    ...
                    <button
                      onClick={() => {
                        const nextVal =
                          tempSettings.orderEmailEnabled !== false
                            ? false
                            : true;
                        setTempSettings((prev) => ({
                          ...prev,
                          orderEmailEnabled: nextVal,
                        }));
                        togglePreference("emailOrderAlerts");
                      }}
                      className={cn(
                    ...
                    >
                      <motion.div
                        animate={{
                          x: tempSettings.orderEmailEnabled !== false ? 26 : 4,
                        }}
                  ...
                  {tempSettings.orderEmailEnabled !== false && (
                    <div className="mt-6 space-y-6 p-6 bg-neutral-950/40 rounded-[1.5rem] border border-neutral-900/50">
                      <div className="space-y-3">
                        <label className="text-[10px] font-bold uppercase tracking-widest text-[#d4af37] block px-2">
                          Notification Recipient Email
                        </label>
                        <input
                          type="email"
                          value={tempSettings.orderNotificationEmail || ""}
                          onChange={(e) =>
                            setTempSettings((prev) => ({
                              ...prev,
                          ...
                          placeholder="e.g. MdSafi2008@gmail.com"
                          className="w-full px-6 py-4 bg-neutral-900 border border-neutral-800 rounded-2xl text-[10px] font-bold tracking-widest text-white placeholder:text-neutral-700 focus:outline-none focus:border-brand-accent transition-all"
                        />
                      </div>
                      ...
                      <div className="space-y-3">
                        ...
                        <input
                          type="url"
                          value={tempSettings.appsScriptUrl || ""}
                          onChange={(e) =>
                            setTempSettings((prev) => ({
                              ...prev,
                          ...
                          className="w-full px-6 py-4 bg-neutral-900 border border-neutral-800 rounded-2xl text-[10px] font-bold tracking-widest text-white placeholder:text-neutral-700 focus:outline-none focus:border-[#d4af37] transition-all"
                        />
                        <span className="text-[8px] text-neutral-500 uppercase tracking-tighter leading-relaxed block px-2">
                          Deploy our custom Google Apps Script Web App in your
                          Google Account and paste the Web App execute URL.
                        </span>
                      </div>
                    </div>
                  )}
                  ...
                  <div className="flex items-center justify-between p-6 bg-neutral-900/50 rounded-2xl border border-neutral-900 group hover:border-brand-accent/30 transition-all">
                    <div className="flex items-center gap-6">
                      ...
                      <div>
                        ...
                        <p className="text-[8px] text-neutral-500 uppercase tracking-tighter leading-relaxed">
                          Receive periodic updates on seasonal collections and
                          researcher insights.
                        </p>
                      </div>
                    </div>
                ...
                <div className="space-y-8">
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-between items-center px-4">
                      ...
                      <span className="text-[8px] text-neutral-500 uppercase font-mono tracking-tighter">
                        Primary Node Background
                      </span>
                    </div>
                    <div className="flex gap-2">
                      ...
                      <label className="flex items-center justify-center w-16 bg-neutral-900 border border-neutral-800 rounded-2xl cursor-pointer hover:border-brand-accent hover:text-brand-accent transition-all group">
                        <input
                          ...
                          className="hidden"
                          accept="image/*"
                          onChange={(e) => handleFileUpload(e, "heroBannerUrl")}
                          disabled={!!uploading}
                        />
                      ...
                      <div className="h-48 w-full rounded-2xl overflow-hidden border border-neutral-800 relative bg-neutral-950/50">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                          <div className="px-3 py-1 bg-black/60 backdrop-blur-md rounded-full border border-white/10 flex items-center gap-2">
                            ...
                            <span className="text-[7px] text-white font-bold uppercase tracking-widest leading-none">
                              REAL-TIME PREVIEW
                            </span>
                          </div>
                        </div>
                  ...
                  <div className="space-y-4 pt-4 border-t border-neutral-900">
                    <div className="flex justify-between items-center px-4">
                      <h4 className="text-[10px] font-bold uppercase tracking-widest text-white">
                        Login Branding Sidebar
                      </h4>
                      <span className="text-[8px] text-neutral-500 uppercase font-mono tracking-tighter">
                        Authentication Portal Visual
                      </span>
                    </div>
                    <div className="flex gap-2">
                      <div className="relative group flex-1">
                        ...
                        <input
                          ...
                          onChange={(e) => {
                            setTempSettings((prev) => ({
                              ...prev,
                              loginSidebarUrl: e.target.value,
                            }));
                            setUploadError(null);
                          }}
                          placeholder="IMAGE URL (.JPG / .PNG)"
                      ...
                      <label className="flex items-center justify-center w-16 bg-neutral-900 border border-neutral-800 rounded-2xl cursor-pointer hover:border-brand-accent hover:text-brand-accent transition-all group">
                        <input
                          ...
                          accept="image/*"
                          onChange={(e) =>
                            handleFileUpload(e, "loginSidebarUrl")
                          }
                          disabled={!!uploading}
                        />
                    ...
                    <div className="px-4 py-3 bg-red-500/10 border border-red-500/20 rounded-2xl flex flex-col gap-1">
                      ...
                      {uploadError
                        ...
                        <p className="text-[7px] text-neutral-500 uppercase tracking-tighter pl-4">
                          Action Required: Create a public bucket named 'assets'
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="p-8 bg-neutral-900/30 border border-neutral-900 rounded-3xl">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <h4 className="text-[9px] font-bold uppercase tracking-widest text-white">
                        Researcher Identity Visibility
                      </h4>
                    </div>
                    <p className="text-[8px] text-neutral-500 uppercase tracking-tighter leading-relaxed mb-6">
                      Determine if your administrative designation is visible to
                      secondary nodes.
                    </p>
                    <button
                      ...
                      className={cn(
                        ...
                        preferences.dataPrivacyVisible
                  ...
                  <div className="p-8 bg-neutral-900/30 border border-neutral-900 rounded-3xl flex flex-col justify-center items-center text-center">
                    ...
                    <button className="mt-4 text-[7px] text-brand-accent underline underline-offset-4 uppercase tracking-widest font-bold hover:text-white transition-colors">
